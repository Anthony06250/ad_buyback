...
final class BuyBackMessageFormDataHandler implements FormDataHandlerInterface
{
    /**
    ...
    {
        $command = (new CreateBuyBackMessageCommand())->fromArray($data);
    ...
    public function update($id, array $data): void
    {
        ...
        $command = (new EditBuyBackMessageCommand((int)$id))->fromArray($data);

...
use AdBuyBack\Domain\BuyBack\Query\GetBuyBackForForm;
use AdBuyBack\Domain\BuyBack\QueryResult\BuyBackForForm;

final class GetBuyBackForFormHandler extends AbstractQueryHandler
{
    /**
     * @param GetBuyBackForForm $query
     * @return BuyBackForForm
     */
